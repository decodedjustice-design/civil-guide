...
export const POLICE_LAW_MODULES: LawModule[] = [
  {
    ...
    authorities: [
      { citation: "State v. Acrey, 148 Wn.2d 738, 64 P.3d 594 (2003)", title: "Terry stop—reasonable suspicion", type: "case", jurisdiction: "Washington", url: "https://law.justia.com/cases/washington/supreme-court/2003/72259-5-1.html", note: "Washington Supreme Court authority discussing investigative detention and reasonable suspicion." },
      { citation: "U.S. Const. amend. IV", title: "Fourth Amendment", type: "case", jurisdiction: "United States", url: "https://constitution.congress.gov/constitution/amendment-4/", note: "Primary constitutional authority governing unreasonable searches and seizures." }
    ]
  },
  {
    ...
    authorities: [
      ...
      { citation: "Wash. Const. art. I, § 7", title: "Invasion of private affairs or home prohibited", type: "statute", jurisdiction: "Washington", url: "https://lawfilesext.leg.wa.gov/law/constitution/Table%20of%20Contents/TABLE%20OF%20CONTENTS.htm", note: "Primary Washington constitutional provision protecting private affairs and homes from disturbance without authority of law." }
    ]
  },
  {

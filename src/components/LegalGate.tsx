    ...
    <div className="fixed inset-0 z-[100] bg-background/95 backdrop-blur-sm flex items-center justify-center px-4">
      <div className="w-full max-w-2xl rounded-2xl border border-border bg-card p-8 shadow-2xl">
        ...
        <p className="text-sm text-muted-foreground mb-6 leading-relaxed">
          Before continuing, please confirm you understand how this platform is designed to support educational and organizational use.
        </p>
        ...
        <div className="space-y-4 mb-6">
          ...
          <label className="flex items-start gap-3 text-sm text-foreground">
            ...
            />
            <span>I understand this platform is for educational and organizational purposes only.</span>
          </label>
        </div>

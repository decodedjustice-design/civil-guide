        ...
        <div className="relative z-10 w-full max-w-md mx-auto px-6 py-12 animate-fade-up">
          ...
          <div className="p-7 rounded-xl bg-cream/95 backdrop-blur-md shadow-lg border border-border/30">
            ...
            <button
              ...
              className="w-full h-12 flex items-center justify-center gap-3 rounded-lg border border-border bg-white hover:bg-secondary/40 text-foreground font-medium text-sm transition-all duration-200 tracking-wide disabled:opacity-50"
            >
